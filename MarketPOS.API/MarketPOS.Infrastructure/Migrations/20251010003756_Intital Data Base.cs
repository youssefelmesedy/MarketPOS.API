    ...
    public partial class IntitalDataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RefToken = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveIngredinentsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductActiveIngredient", x => new { x.ProductId, x.ActiveIngredinentsId });
                    table.ForeignKey(
                        name: "FK_ProductActiveIngredient_ActiveIngredinents_ActiveIngredinentsId",
                        column: x => x.ActiveIngredinentsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountPercentageFromSupplier = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "ProductUnitProfiles",
                columns: table => new
                {
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LargeUnitName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    MediumUnitName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SmallUnitName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    MediumPerLarge = table.Column<int>(type: "int", nullable: false),
                    SmallPerMedium = table.Column<int>(type: "int", nullable: false),
                    LargeUnitPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    MediumUnitPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    SmallUnitPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUnitProfiles", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_ProductUnitProfiles_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductActiveIngredient_ActiveIngredinentsId",
                table: "ProductActiveIngredient",
                column: "ActiveIngredinentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_RefToken_UserId",
                table: "RefreshTokens",
                columns: new[] { "RefToken", "UserId" },
                unique: true);
