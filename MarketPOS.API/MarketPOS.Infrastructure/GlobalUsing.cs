...
//framework using
global using MarketPOS.Application.RepositoryInterfaces.RepositoryCategoryAndWareHouse;
global using MarketPOS.Application.Services.InterfacesServices.EntityIntrerfaceService;
global using MarketPOS.Design.Decorator;
global using MarketPOS.Infrastructure.Repositories.GenericRepositoryAndBaseBuliderQuery;
global using MarketPOS.Infrastructure.Repositories.RepositoryCategoryAndWareHouse;
global using MarketPOS.Infrastructure.Services.AggregateService;
global using MarketPOS.Infrastructure.Services.CategoryService;
global using MarketPOS.Infrastructure.Services.GenericService;
global using MarketPOS.Infrastructure.Services.IngredientService;
global using MarketPOS.Infrastructure.Services.ProductAndNavigetionEntity;
global using MarketPOS.Infrastructure.Services.SupplierService;
global using MarketPOS.Infrastructure.Services.WareHouseService;
// global using 
